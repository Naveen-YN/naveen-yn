...
const HeroSection: React.FC = () => {
  ...
  const { aboutMeData, activeResume } = useData();
  ...
  // Get the resume URL from either the active resume or fallback to the about me data
  const resumeUrl = activeResume?.fileUrl || aboutMeData.resumeUrl || "https://novark.s3.ap-south-1.amazonaws.com/Naveen-Yanamadala-Resume-1.pdf";
  ...
  return (
    <section className="relative h-screen overflow-hidden flex items-center justify-center">
      ...
      >
        <source src="https://novark.s3.ap-south-1.amazonaws.com/ntech.mp4" type="video/mp4" />
      ...
      {/* Main Content - Added proper mobile padding */}
      <div className="absolute inset-0 flex items-center justify-center px-6 sm:px-8 md:px-12">
        ...
        >
          {/* Enhanced Glass Card without Top White Gloss */}
          <div className="relative bg-black/20 backdrop-blur-md p-6 md:p-8 lg:p-10 rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
            {/* Subtle Glow Border - Left Bottom Edge Only */}
            ...
            <div className="relative z-10">
              ...
              >
                Hello, I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#09c6f9] to-[#045de9] drop-shadow-none">Naveen Yanamadala</span>
              </motion.h1>
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="drop-shadow-sm">View My Resume</span>
